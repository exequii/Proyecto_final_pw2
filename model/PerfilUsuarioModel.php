...
class PerfilUsuarioModel{
    ...
    public function getDatosUsuario($id){
        $sql ="SELECT   reserva.numero_asiento,reserva.fila_asiento,reserva.tipo_servicio,reserva.comprobante, vuelo.dia, vuelo.duracion, vuelo.horario, vuelo.origen, vuelo.tipo_vuelo, vuelo.destino 
